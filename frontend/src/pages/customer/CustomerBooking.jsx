...
export default function CustomerBooking() {
  ...
  const availableRooms = rooms.filter(
    (r) =>
      (r.status === "available" || r.TrangThai === "Available") &&
  ...
  const validateStep2 = () => {
    ...
    if (new Date(checkInDate) < new Date()) {
      toast({
        title: "Ngày nhận phòng phải từ hôm nay trở đi",
        variant: "destructive",
      });
      return false;
    }
    ...
    if (availableRooms.length === 0) {
      toast({
        title: "Không có phòng trống cho loại phòng này",
        variant: "destructive",
      });
      return false;
    }
  ...
  const handleConfirmBooking = () => {
    toast({
      ...
      description:
        "Chúng tôi sẽ xác nhận đặt phòng của bạn trong thời gian sớm nhất",
    });
      ...
      {step === 2 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Phòng {selectedRoomType} - {roomInfo?.price.toLocaleString()}{" "}
              VNĐ/đêm
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {roomInfo?.price.toLocaleString()} VNĐ/đêm
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="p-4 bg-warning/10 border border-warning/20 rounded-lg">
              <p className="text-sm text-warning-foreground">
                <strong>Lưu ý:</strong> Đặt phòng sẽ được giữ trong 24 giờ. Vui
                lòng thanh toán đặt cọc để xác nhận đặt phòng.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <Dialog open={confirmDialogOpen} onOpenChange={setConfirmDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Bạn có chắc chắn muốn đặt phòng {selectedRoomType} từ{" "}
